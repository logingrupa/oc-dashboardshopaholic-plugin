...
.PHONY: test analyse baseline rector-dry rector phpmd pint pint-test all
...
phpmd:
	cd $(PROJECT_ROOT) && $(VENDOR_BIN)/phpmd $(PLUGIN_DIR)/classes,$(PLUGIN_DIR)/models,$(PLUGIN_DIR)/console,$(PLUGIN_DIR)/vuecomponents/NewOrdersList.php,$(PLUGIN_DIR)/Plugin.php text $(PLUGIN_DIR)/phpmd.xml
